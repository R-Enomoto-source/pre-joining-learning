...
class Ex1_05_1 {
	public static void main (String[] args) {
		int japaneseITIndustryLifetimeWage = 26000000 ;  //①
		long japaneseItMarketSize = 2664120000000L ;     //②
		char myfavoriteKanji = '猶' ;                    //③
		String mydreamjob = "研究者" ;                   //④
		boolean isMePreviousGraduate = true ;            //⑤
