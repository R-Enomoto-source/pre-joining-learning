...
public class Ex1_14_2 {
	...
	**  - 引数として受け取った値が5000円より大きい場合、1000円より大きく5000円以下の分について10％割引、5000円より大きい分について20％割引にする　途中
	...
	*/
	static int discount( int totalAmount ){            //アンダーバーを適切な内容に書き換えてください
		...
		//金額ごとの値引き額の計算
		int discountCriteria_1 = (totalAmount - 1000)/10 ;
		int discountCriteria_2 = (5000-1000)/10 + (totalAmount - 5000)/5;
		
		if(discountCriteria_2 > 5000 ){
			discountCriteria_2 = 5000 ;
		}

		if(totalAmount < 1000){
			discountedtotalAmount = totalAmount ;
		}else if(totalAmount >= 1000 && totalAmount <= 5000){
			discountedtotalAmount = totalAmount - discountCriteria_1; //1000円以上5000円以下の場合、1000円より大きい分について10％割引
		}else if(totalAmount > 5000){
			discountedtotalAmount = totalAmount - discountCriteria_2;//5000円より大きい場合、同上、5000円より大きい分について20％割引にする
		}else{
